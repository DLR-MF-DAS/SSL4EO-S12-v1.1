...
#
# This file contains data loading scripts for the Zarr chunk file version of SSL4EO-S12 v1.1
# from https://huggingface.co/datasets/embed2scale/SSL4EO-S12-v1.1-Zarr.
...
# Attention: These S2 mean statistics include a +1000 offset to align with the newest ESA processing version.
# The offset was removed in the later webdataset version of SSL4EO-S12 v1.1 due to usability.
...
class ZarrDataset(Dataset):
    def __init__(
        ...
        """
        Dataset class for the SSL4EOS12 V1.1 dataset as Zarr chunk files, available at
